...
<section id="imageParrallaxBillet" >
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 d-flex justify-content-center">
            <a class="boutonAdministration" href="">Chapitres en cours d'ecriture </a>
        </div>
    ...
    <div class="row justify-content-center chapitreEnCours">
        <div >
            <h3>Chapitres en Cours </h3>
            <table>
                <tr>
                    <th>Numéro chapitre </th>
                    <th>Titre</th>
